...
public class MessageRouterPDUTest
{
	...
	{
		final MessageRouterProtocol pdu = new MessageRouterProtocol(CNService.Get_Attribute_Single, CNPath.Identity().instance(0x24).attr(0x06), new ProtocolAdapter());
	...
	{
		final MessageRouterProtocol pdu = new MessageRouterProtocol(CNService.CIP_ReadData, CNPath.Symbol("kay_ai"),
				new ProtocolAdapter()
		{
			@Override
