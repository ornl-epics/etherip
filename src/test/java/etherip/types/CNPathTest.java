...
public class CNPathTest
{
    ...
    public void testSymbolPath() throws Exception
    {
        ...
        buf.flip();
        assertThat(Hexdump.toCompactHexdump(buf),
                equalTo("0000 - 04 91 06 6D 79 5F 74 61 67 - ...my_tag"));
        ...
        assertThat(path.toString(),
                equalTo("Path Symbol(0x91) 'my_tag2', 0x00"));

        buf.clear();
        path.encode(buf, null);
        buf.flip();
        assertThat(Hexdump.toCompactHexdump(buf), equalTo(
                "0000 - 05 91 07 6D 79 5F 74 61 67 32 00 - ...my_tag2."));
    }
}
