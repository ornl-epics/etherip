...
public class MessageRouterPDUTest
{
    ...
    public void testGetAttrib() throws Exception
    {
        ...
        assertThat(Hexdump.toCompactHexdump(this.buf),
                equalTo("0000 - 0E 03 20 01 24 24 30 06 - .. .$$0."));
    ...
    public void testReadData() throws Exception
    {
        ...
        assertThat(Hexdump.toCompactHexdump(this.buf), equalTo(
                "0000 - 4C 04 91 06 6B 61 79 5F 61 69 01 00 - L...kay_ai.."));
